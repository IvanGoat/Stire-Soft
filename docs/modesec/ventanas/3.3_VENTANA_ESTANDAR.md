...
| **[B] Menú** | Banco de trabajo, Módulos/Temas, Repasos, Bitácora, Tutor | Mis Clases, Catálogo/Banco de Ejercicios, Analítica, Tareas por Calificar | Gestión de Usuarios, Instituciones, Parámetros del Sistema, Logs de Auditoría |
...
El inventario completo de las **15 ventanas** que heredan de este modelo está especificado en:
👉 [`3.3.1_FICHAS_VENTANAS.md`](3.3.1_FICHAS_VENTANAS.md)

- **Común (1):** `COMP-V00` (Autenticación y Acceso)
- **Estudiante (6):** `EST-V01` (Banco de trabajo), `EST-V02` (Teoría), `EST-V03` (Resolución de ejercicio), `EST-V04` (Tutor IA), `EST-V05` (Mantenimiento SM-2), `EST-V06` (Bitácora/Progreso)
- **Docente (5):** `DOC-V01` (Panel de clases), `DOC-V02` (Gestión de contenidos), `DOC-V03` (Editor de ejercicios), `DOC-V04` (Analítica de cohorte), `DOC-V05` (Seguimiento individual)
