...
**Estado:** ✅ Completo (Flujos para Estudiante, Docente y Administrador) · **Última actualización:** 2026-08-30
...
stateDiagram-v2
    ...
    state "Rol: Estudiante" as R_EST {
        EST_V01: EST-V01 Mi Banco de Trabajo (Hub)
        EST_V02: EST-V02 Unidad de Aprendizaje
        EST_V03: EST-V03 Resolución de Ejercicio
        EST_V04: EST-V04 Maestro de Taller (Tutor IA)
        EST_V05: EST-V05 Mantenimiento (SM-2)
        EST_V06: EST-V06 Mi Bitácora de Dominio
    ...
    state "Rol: Docente" as R_DOC {
        DOC_V01: DOC-V01 Panel Docente (Hub)
        DOC_V02: DOC-V02 Gestión de Clases
        DOC_V03: DOC-V03 Unidades y Contenido
        DOC_V04: DOC-V04 Seguimiento por Alumno
        DOC_V05: DOC-V05 Mensajes y Tutoría

        DOC_V01 --> DOC_V02 : Administrar clases y alumnos
        DOC_V01 --> DOC_V03 : Gestionar unidades y teoría
        DOC_V01 --> DOC_V04 : Ver progreso pedagógico
        DOC_V01 --> DOC_V05 : Abrir canal de mensajes
        DOC_V02 --> DOC_V04 : Ver ficha de alumno de la clase
        DOC_V02 --> DOC_V01 : Retornar al panel
        DOC_V03 --> DOC_V01 : Retornar al panel
        DOC_V04 --> DOC_V01 : Retornar al panel
...
| 7 | `EST-V01` | `EST-V05` | Clic en "Mantenimiento / Repasos de hoy" | Sí | Consulta unidades vencidas en SM-2 |
| 8 | `EST-V01` | `EST-V06` | Clic en "Mi bitácora" | Sí | Carga analítica y métricas de dominio |
| 9 | `EST-V02` | `EST-V03` | Clic en "Ir a resolver el problema" | Sí | Abre entorno de programación |
| 10 | `EST-V03` | `EST-V04` | Clic en "Pedir pista al Maestro" | Sí (modal) | Inyecta código actual como contexto socrático |
...
| 14 | `DOC-V01` | `DOC-V02` | Clic en "Gestionar Clases" | Sí | Carga listado de cursos asignados |
| 15 | `DOC-V01` | `DOC-V03` | Clic en "Unidades de Aprendizaje" | Sí | Abre gestor curricular |
| 16 | `DOC-V01` | `DOC-V04` | Clic en "Seguimiento de Estudiantes" | Sí | Lista alumnos matriculados con métricas |
| 17 | `DOC-V01` | `DOC-V05` | Clic en "Mensajes" | Sí | Carga hilos de conversación |
| 18 | `DOC-V02` | `DOC-V04` | Clic en un alumno de la clase | Sí | Muestra detalle individual de mastery |
