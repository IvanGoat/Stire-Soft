...
*   **Detalle:** `docs/ADR_DECISIONES_ARQUITECTURA.md` (versión pública, redactada sin payloads de ataque literales ni código desactualizado — el detalle completo de hallazgos de seguridad sigue gitignorado en los documentos de auditoría, ver `.gitignore`).
