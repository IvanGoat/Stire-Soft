...
Los Sistemas Tutores Inteligentes en programación (ITS-Prog) son herramientas computacionales que modelan el proceso de enseñanza-aprendizaje adaptándose a las necesidades individuales del estudiante (Anderson et al., 1995; VanLehn, 2011).
...
2. **Deep Knowledge Tracing (DKT):** Utiliza redes recurrentes (LSTM) para predecir el desempeño futuro basándose en la secuencia completa de entregas pasadas (Piech et al., 2015).
...
### 1.3 Método Socrático con LLMs (Chen et al., 2023)
...
| `EST-V04` | Estudiante | Tutor Socrático LLM (Chen et al., 2023) | Chat contextual con Gemini 1.5 guiado por el nivel de maestría del alumno. |
...
| `DOC-V04` | Docente | Dashboards de Orquestación (Molenaar) | Analítica grupal con cuadrante de alumnos en riesgo (`avgMastery < 50%`). |
